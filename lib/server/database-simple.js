...
class MemoryDatabase {
  ...
  createMemo(data) {
    const { content, tags = '', visibility = 'private', pinned = false, archived = false, createdAt, updatedAt } = data;
    ...
    const memo = {
      ...
      created_ts: createdAt || now,  // 支持自定义创建时间
      updated_ts: updatedAt || now   // 支持自定义更新时间
    };
